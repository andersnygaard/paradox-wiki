...
type: Concept
title: Deck
description: The Paradox's side decks and foredeck — framing, laying the deck skin, and a non-skid finish — plus the brass-tube stowage loops that retain the yuloh and the lowered mast/rig on deck, including how to install the pipe stowage rails and how the rig is stored ashore.
tags: [paradox, components, deck, construction, non-skid, deck-hardware, yuloh, rig-stowage]
timestamp: 2026-07-23T00:00:00Z
---

# Deck

The Paradox's side decks and foredeck: their framing, laying the deck skin, and finishing it with a non-skid surface. The deck also carries a pair of brass-tube retaining loops, one to each side of the coach roof, that stow the [yuloh](/components/yuloh.md) to starboard and the lowered mast/rig to port.
...
- **Starboard loop** — retains the [yuloh](/components/yuloh.md) (a Chinese-style sculling oar, used for auxiliary propulsion in calm conditions or close quarters).
...
Where the usual launch site is a half-mile trailer haul from home, even lashing the rig to the sail bundle on deck for a short trip is likely good enough, rather than breaking the spars down for garage storage every time.[17]

### Rigging at the launch site, and stowing the spars for the road

A related practice answers the road-transport version of the same question directly: rather than leave the rig assembled and lashed on deck for the drive, the whole rig — mast, boom, yard, and sail — stows fully inside the hull for transport, loaded and retrieved through a dedicated **inspection hatch on the transom**. The boat is then rigged completely ready to sail only once at the launch site itself, so getting underway becomes simply a matter of sliding the trailer into the water. The advantage claimed for this approach is one of security as much as convenience: with nothing loose or removable left exposed on the outside of the boat for the drive, there is nothing to drop off or be stolen while on the road.[19] The underlying question — how a boom's tack fitting, seemingly too large for the transom opening, is meant to pass through it at all — had been raised without a full answer at the time spars were first discussed for on-deck stowage (see [storing the mast, boom, and sail when not sailing](#storing-the-mast-boom-and-sail-when-not-sailing) above); this practice confirms the fit does work in at least one case.[18] Whether the mast itself fits fully inside the hull can depend on whatever is fixed to its head — see [mast interior sealing and anchor-light fit — further anchor-light and lightning-rod length fixes](/construction/mast-sealing-and-fit.md#further-anchor-light-and-lightning-rod-length-fixes) for the anchor-light and lightning-rod length problems this can cause, and the fixes tried.
