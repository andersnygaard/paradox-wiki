...
[1] Archive message page_009 (Glen C. Maxwell, 2001-07-07) — ~500 hrs over a two-year period, worked on intermittently.
[85] Archive message page_2952 (dclark / "dclark52001" / Derek Clark, `paradoxbuilders`, msgnum 2983, 2005-07-24) — "Re: new to the group.....& Enuf progress": spent a day preparing one side of "Enuf" for glassing while she sat roughly 10 in off the floor on baulks of timber; wanting the side more vertical rather than sloping inward and away from him, realized before cutting 4 ft wedges that nailing a pair of 2x2 stops to one end of the baulks (to stop the boat sliding away) and lifting the other side on a trolley jack did the job just as well. Signed "Derek."
[1a] Archive message page_253 (Glen Maxwell / "ifida", `paradoxbuilders`, 2002-01-14) — "Re: Thanks everyone...": two years on-again/off-again to finish "Zoë," with the last three months worked intensely; over a thousand hours total, which he notes equals about six months of full-time (40 hr/week) work; could have been finished in a lot less time.
[1b] Archive message page_287 (Glen Maxwell, `paradoxbuilders`, 2002-01-25) — "Re: Completion time?": reconfirms, to a new questioner ("futabachan"/"Sue"), about two years of on-and-off work and approximately 1,000 hours to build "Zoë"; could be done in less time; the finish desired determines the time invested.
[1c] Archive message page_606 (nils19602002 / Nils, `paradoxbuilders`, msgnum 607, 2002-08-02) — "construction time": asks where to get the plans and for an approximate building time.
[1d] Archive message page_607 (ifida / Glen Maxwell, `paradoxbuilders`, msgnum 608, 2002-08-02) — "Re: construction time": plans available from Dave Bolduc (`mbolduc@triad.rr.com`); building time varies with workmanship and finish desired — about 400 hrs for a "slam dunk," 1,000 or more for a nicely finished example.
[2] Archive message page_005 (Glen C. Maxwell, 2001-07-07) — "challenging and rewarding," "tricky details."
[3] Archive message page_008 (Alastair, 2001-07-07) — garage only 2 ft longer than the finished boat.
[4] Archive message page_048 (Dave Bolduc, 2001-09-04) — Matt built the original Paradox in about 4 months of full-time work.
[5] Archive message page_090 (mbolduc / Dave Bolduc, `paradoxbuilders`, 2001-11-09) — Paradox cost Matt ~$2,000 to build and took 3 months; Little Cruiser cost Dave and Mindy $1,600 secondhand, needed refitting after 3 years of full-time cruising; Swamp Thing sold for $600 a few years earlier.
[6] Archive message page_159 (c_i_becker / Chris Becker, `paradoxbuilders`, 2001-12-11) — "A Query": all ten sheets of plywood cost $AUS790 (Pacific Maple marine ply, void-free).
[7] Archive message page_346 (David LeBlanc, `paradoxbuilders`, 2002-02-15) — "Keeping the dream alive": build-motivation suggestions (log-keeping, skill-building, reward gear purchases, destination research) closing with "build on your boat at least every week."
[8] Archive message page_882 (erniefossel / "botebilder", `paradoxbuilders`, msgnum 897, 2003-03-20) — "back on the (saw) horse": his Paradox-in-progress and boat shed were destroyed by trees knocked down in a windstorm the previous New Year's Eve; devastation killed his enthusiasm for a time; now cutting out pieces again; asks whether anything about the early building stages has changed or been learned in the last ~6 months.
[46] Archive message page_1732 (kd7ixk / David C. Smith, `paradoxbuilders`, msgnum 1754, 2004-01-03) — "Re: Build Manual, Preparations": thanks Al for the input; the tool list was meant as suggested, not minimal, and he is hesitant to compile a stripped-down alternative since what is minimal for one builder is luxuriously expansive for another; built his first boat almost entirely with a block plane and a coping saw, but would use many more tools today for the same result; urges builders to gain tools as experience grows and just start.
[47] Archive message page_1733 (whisper / "David LeBlanc", `paradoxbuilders`, msgnum 1755, 2004-01-02) — "Re: Build Manual, Preparations": calls the tool list "wildly excessive," joking it would cost more than the boat; none of the stationary tools are actually needed ("well over $5,000" saved); cites a fiddlier boat design whose designer and wife built the prototype using only an electric drill and planer as power tools, hiring a circular saw once for the mast; proposes a tiered minimum/nice-to-have/luxury list structure instead of one comprehensive list.
[48] Archive message page_1735 (kd7ixk / David C. Smith, `paradoxbuilders`, msgnum 1757, 2004-01-03) — "Re: Build Manual, Preparations": responds to Al and David's excess concerns; quantifies his own stationary power tools at no more than $1,200 new, with a $300 drill press deliberately deferred; disparages the "modern outlook" that prizes ornamental tool finishes over usability; invites anyone dissatisfied to compile their own list; urges starting the build before either list is complete.
[49] Archive message page_1738 (kd7ixk / David C. Smith, `paradoxbuilders`, msgnum 1760, 2004-01-03) — "Re: Build Manual, Preparations": reposts the full categorized "Preparations" tool list and build-site guidance verbatim, asking which specific tools the group judges unnecessary, absent a consensus to trim any particular item.
[50] Archive message page_1740 (whisper / "David LeBlanc", `paradoxbuilders`, msgnum 1762, 2004-01-02) — "Re: Build Manual, Preparations": apologizes for having "come across a bit more strident than intended"; restates his concern that a long tool list has a real deterrent effect on likely first-time builders, reinforcing his tiered minimum/nice-to-have/luxury suggestion.
[51] Archive message page_1741 (LJGeib / "Larry", `paradoxbuilders`, msgnum 1763, 2004-01-03) — "Re: Build Manual, Preparations": replying to Smith's dislike of the "modern outlook" on tools (quoted in full), makes the case for fine antique tools — tool steel, rosewood, and brass handles are an old tradition, not a modern marketing invention; describes accumulating his own tools cheaply over years from estate/farm sales, trades, and gifts from older tradesmen, rather than paying list price new; advises striking at a good opportunity rather than waiting for a current project to justify it, since a fine tool at a good price will find appreciative hands and repay its cost through use or trade, though a "new" find may need a day or more of derusting, cleaning, sharpening, and tuning; some of his own tools are Victorian-era and have passed through five-plus generations of craftsmen, which he takes as proof an inferior tool could not have lasted; notes such age can make a tool valuable to collectors, though that isn't why he owns them — old tools are simply more enjoyable and accurate to use, and sometimes outperform modern equivalents (cites planes suited to pitch-laden wood); closes reflecting that these tools connect him to the men who came before, and that he is starting to think about who will use his own next.
[52] Archive message page_1743 (dclark52001 / "Derek Clark", `paradoxbuilders`, msgnum 1765, 2004-01-03) — "Re: Build Manual, Preparations & Tools": replying to Larry's tool-heritage message, distinguishes a tradesman/serial hobbyist (for whom investing in good tools over time makes sense) from a one-boat builder building from necessity (who should start with what's on hand and buy only as real need appears); recounts starting his own building life with three saws, three chisels, a brace, a hand drill, a No. 4 plane, a combination square, and assorted pencils/rules, with his first power tool an ordinary drill mounted in a stand as an improvised pillar drill; sold his radial arm saw and planer/thicknesser after finding he never felt safe with them, given how infrequently he did woodwork, and returned to hand tools; concludes fine tools are a delight but unnecessary to build one plywood boat, power tools mainly save time at some cost to finger safety, and an undecided builder should buy timber first and tools to suit the job after — "the price of ply is daunting enough." Signed "Derek."
[53] Archive message page_1745 (openboat / "Alastair", `paradoxbuilders`, msgnum 1767, 2004-01-03) — "Re: Build Manual, Preparations": endorses splitting the tool list into essential and desirable categories; distinguishes builders who enjoy building (the majority) from those, like himself, who mainly want to go boating and had never wanted to build a boat before Paradox, with no interest in building another once finished; his own approach was to buy only essential tools at the lowest price — a cordless drill, angle grinder, and jigsaw bought cheap specifically for the project, plus a table saw bought on Don's advice that he now regrets; judges it should be possible to finish a Paradox spending well under about 50 UKP on tools, and doesn't want the tool-list debate to discourage this type of prospective builder from starting; quotes Smith's original "Preparations" tool-list request for specific unnecessary items in full. Signed "Al, Yeovil, England."
[54] Archive message page_1746 (dlb / "David Beard", `paradoxbuilders`, msgnum 1768, 2004-01-03) — "Re: Build Manual, Preparations": agreeing with Alastair's basics-first approach, adds one specific recommendation — a 6 in orbital sander, great for aggressive sanding; quotes Alastair's full essential/desirable message and Smith's original tool-list request in the same message. Signed "David."
[55] Archive message page_1747 (whisper / "David LeBlanc", `paradoxbuilders`, msgnum 1769, 2004-01-03) — "The tools list": forwarded the tools list to his friend John Welsford, a New Zealand boat designer and author, for comment; quotes Welsford's reply in full — tool "need" is as much a perception shaped by advertisers as a real requirement, weighed against a builder's own time/money budget; his own shop would make the debated list look understocked, but a Paradox could be built with far less, per the carry-box of tools pictured on p. 33 of his own book *The New Zealand Backyard Boatbuilder*; his first 21 ft boat was built with only a 3/8 in-chuck two-speed Hitachi drill as its sole power tool, entire toolkit fitting in one toolbox; everything beyond the essentials is "nice to have," easy to overspend on to the point of merely enriching the tool-shop owner; a full stationary-tool shop only makes sense for production-basis building; Nelson's Victory was built entirely with hand tools; notes he has built 19 boats in about 18 years and is about to start a 12-ton cruiser. Signed "David LeBlanc, Seattle, WA USA."
[9] Archive message page_883 (openboat / Alastair, `paradoxbuilders`, msgnum 898, 2003-03-20) — "Re: back on the (saw) horse": sorry to hear about the shed and boat; the only thing he'd do differently early on is not bother getting cleat sizes precisely accurate — he planed much of his own wood exactly to spec and it wasn't necessary, extra wood left on would have been fine; do get the plywood bulkheads the right shape, "then everything else will follow."
[10] Archive message page_1002 (openboat / Alastair, `paradoxbuilders`, msgnum 1018, 2003-06-13) — "Re: Leaking inspection plates": "heaven knows" on precise hours; his own build took 18 months of not-very-hard evening/weekend work; would reckon on about a year for a repeat; guesses an experienced, fully-equipped full-time builder could do it in a couple of months.
[11] Archive message page_1058 (keywestdale / "Duane," `paradoxbuilders`, msgnum 1074, 2003-07-10) — "LOOKS LIKE I FOUND MY FUTURE BOAT.....": after four months comparing designs (had nearly picked a Glen-L design, then leaned toward a Long Micro), found Dave and Mindy Bolduc's website by chance and committed to building a Paradox, swayed by prompt, friendly replies from the Bolducs and from Don about the "Building the Paradox" article series and by the design's evident loyal following/active builders' group; values the Paradox's simplicity, affordability, and ease of transport/storage/maintenance; a first-time boatbuilder, "landlocked" in Tennessee for about eight more months before trailering the finished boat to Florida.
[12] Archive message page_1060 (dlb / "buster38801" / David Beard, `paradoxbuilders`, msgnum 1076, 2003-07-10) — "Re: LOOKS LIKE I FOUND MY FUTURE BOAT.....": asks Duane what part of Tennessee he is from, noting he himself is in Mississippi.
[13] Archive message page_1061 (keywestdale / "Duane," `paradoxbuilders`, msgnum 1077, 2003-07-10) — "Re: LOOKS LIKE I FOUND MY FUTURE BOAT.....": gives his location as Cookeville, TN, midway between Nashville and Knoxville on Interstate 40; asks David Beard's location in Mississippi and whether he is building or has completed his boat.
[14] Archive message page_1062 (dlb / David Beard, `paradoxbuilders`, msgnum 1078, 2003-07-10) — "Re: LOOKS LIKE I FOUND MY FUTURE BOAT.....": Tupelo, MS, 90 mi SE of Memphis; has one Paradox sailing and one under construction; a first-time builder himself.
[15] Archive message page_1063 (LJGeib / "Larry," `paradoxbuilders`, msgnum 1079, 2003-07-10) — "Re: LOOKS LIKE I FOUND MY FUTURE BOAT.....": welcomes Duane to the group, jokingly asks him to stop typing in all capital letters.
[16] Archive message page_1064 (keywestdale / "Duane," `paradoxbuilders`, msgnum 1080, 2003-07-10) — "FINSIHED MY PROFILE......": completed his Yahoo Groups profile so his e-mail address is visible to other members.
[17] Archive message page_1065 (whisper / David LeBlanc, `paradoxbuilders`, msgnum 1081, 2003-07-10) — "Re: FINSIHED MY PROFILE......": welcomes Duane, jokingly notes that typing in all capitals reads as shouting online.
[18] Archive message page_1066 (ifida / Glen Maxwell, `paradoxbuilders`, msgnum 1082, 2003-07-10) — "Re: LOOKS LIKE I FOUND MY FUTURE BOAT.....": "Welcome aboard Duane! Tailwinds, Glen."
[19] Archive message page_1083 ("DUANE HALL" / keywestdale, `paradoxbuilders`, msgnum 1099, 2003-07-17) — "PLANS IN HAND !!!!": full text and citation at [construction/plywood-grades-and-foam-flotation.md](/construction/plywood-grades-and-foam-flotation.md#a-new-builders-exterior-vs-marine-choice-and-why-marine-usually-wins-on-labor).
[20] Archive message page_1145 (kleerig / Ken Riggins, `paradoxbuilders`, msgnum 1162, 2003-08-20) — "Thanks": received his plans from Dave and Mindy Bolduc and the "Building Paradox" articles from Don Elliott; thanks them both for their promptness, and thanks everyone who has contributed build photos; looking forward to starting construction on his own small cruiser.
[21] Archive message page_1147 (ifida / Glen Maxwell, `paradoxbuilders`, msgnum 1164, 2003-08-22) — "Re: Thanks": "Welcome Ken, keep us posted on your progress."
[22] Archive message page_1154 (kleerig / Ken Riggins, `paradoxbuilders`, msgnum 1171, 2003-09-01) — "Getting Started": reports removing his first deck beam from the jig, "dead on" and much easier than expected; expects to be in the water "in a couple of years of weekend work"; thanks the list for setting good examples.
[23] Archive message page_1155 (ifida / Glen Maxwell, `paradoxbuilders`, msgnum 1172, 2003-09-01) — "Re: Getting Started": "Great Ken!, keep us posted."
[24] Archive message page_1285 (w.serjeant / "barnacleid" / Bill Serjeant, `paradoxbuilders`, msgnum 1305, 2003-11-14) — "Tools": perturbed at photos showing 15 or more clamps used for deck beams; asks how many are actually needed; links his own tool list built from Don Elliott's recommendations (`www.btinternet.com/~w.serjeant/paradox/building.htm`) and asks which tools on it are truly essential.
[25] Archive message page_1286 (kd7ixk / David C. Smith, `paradoxbuilders`, msgnum 1306, 2003-11-14) — "Re: Tools": explains his own clamp-heavy deck-beam photos came from laminating with thinner-than-necessary strips; recommends test-laminating a few thicknesses on the jig without steaming, using the thickest stock that still bends to shape; declines to comment on "Elliot's ramblings or scratchings" (Don Elliott's tool list); tool needs and quality creep up as a build proceeds — built his first boat with mostly a coping saw and block plane, "today, I can not conceive of doing so"; endorses amassing tools the same unintimidated, one-bite-at-a-time way Glen Maxwell counsels tackling the whole build.
[26] Archive message page_1292 (openboat / Alastair, `paradoxbuilders`, msgnum 1312, 2003-11-15) — "Re: Tools": full annotated tool list answering Bill Serjeant's original request, working from Don Elliott's recommended list; most-used power tools were the drill, jig saw, and angle grinder; itemized comments on acid brushes, clamps (screw and spring), the fibreglass cutter, drill bit for the vent trunk drain, low-angle Stanley No. 118 plane, borrowed power planer, bin-liner plastic sheeting, Stanley No. 21-115 Surform, table saw, and yoghurt-pot epoxy mixing tubs; signed "Al, Yeovil, England."
[27] Archive message page_1293 (delliott / Don Elliott, `paradoxbuilders`, msgnum 1313, 2003-11-15) — "Re: Tools": confirms Alastair's list is essentially his own from the "Building Paradox" booklet; flags a since-changed detail — his lead ballast pigs moved from the bread-pan wedge shape to square, elongated forms (roughly 3 x 3 x 12 in, molded in plywood boxes), melted down and re-poured from the original shape; points to the upcoming ballast articles for that shape.
[28] Archive message page_1294 (LJGeib / "Larry," `paradoxbuilders`, msgnum 1314, 2003-11-15) — "Re: Tools": recommends a Nicholson pattern maker's rasp for shaping complex boat parts — smoother than an ordinary rasp or a Surform, comes in a couple of sizes with one flat and one convex side, teeth in a random pattern to avoid grooving, cuts aggressively under firm pressure and leaves a ~50-grit finish under light pressure, well suited to complex shapes such as kayak coamings or Paradox's chine runners; not cheap (paid $20 US about 25 years earlier) and can be hard to find; recommends keeping a file card handy to keep it clean.
[29] Archive message page_1296 (arvent / Nels, `paradoxbuilders`, msgnum 1316, 2003-11-15) — "Re: Tools": points to Lee Valley as a source for the Nicholson-style rasp, at more than double what Larry paid, noting it will pay for itself over time, including for making paddles and oars; gives a leevalley.com link and a fallback search suggestion.
[30] Archive message page_1297 (openboat / Alastair, `paradoxbuilders`, msgnum 1317, 2003-11-15) — "Re: Tools": prefers the wedge shape the bread pan produces over Don's square pigs — his own, cast at 12 kg each, can easily be lifted with one hand because of that shape; paints them with Hammerite while still warm from casting, "and in a couple of minutes your worries about handling lead are over."
[31] Archive message page_1298 (openboat / Alastair, `paradoxbuilders`, msgnum 1318, 2003-11-15) — "Re: Tools": seconds Larry's Nicholson rasp recommendation, "they are great tools"; used the angle grinder for his own chine runners ("not very delicate").
[32] Archive message page_1301 (w.serjeant / "barnacleid" / Bill Serjeant, `paradoxbuilders`, msgnum 1321, 2003-11-15) — "Input to Tools List": thanks the list for its tool suggestions and invites more; reports being unable to find a Nicholson pattern maker's rasp in the UK, and asks for sourcing ideas.
[33] Archive message page_1302 (LJGeib / "Larry," `paradoxbuilders`, msgnum 1322, 2003-11-16) — "Re: Input to Tools List": gives several mail-order sources that ship internationally (sculpt.com, Nolan Supply, Lee Valley, and Garrett Wade, the priciest but with the fullest description), plus a German-made half-round pattern maker's rasp (fine-tools.com) that looks similar though he has no personal experience with it, and suggests trying a tool in person first, "a good tool is a tactile thing"; notes rasp prices have climbed well past the roughly $20 he paid 25 years earlier.
[34] Archive message page_1307 (w.serjeant / "barnacleid" / Bill Serjeant, `paradoxbuilders`, msgnum 1327, 2003-11-16) — "Re: Input to Tools List": thanks Larry; finds the Lee Valley rasp but is "not so keen on the price" — more than double what Larry originally paid.
[35] Archive message page_1317 (arvent / Nels, `paradoxbuilders`, msgnum 1337, 2003-11-16) — "Re: Input to Tools List": only the coarse Nicholson rasp is worth buying; a second, finer one is redundant since small sanding files are a lot cheaper — "unless of course you misplace tools like I do."
[36] Archive message page_1400 (w.serjeant / "barnacleid" / Bill Serjeant, `paradoxbuilders`, msgnum 1420, 2003-11-18) — "Tools list": "Dear all, I take responsibility for the tools list which has sparked some debate. It was a list compiled by me of the tools used by Don to build his Paradox. It was my list, not Don's or any other person's. If I have done anything I should not have, I apologise, but it seems useful to me and as starting point for all who intend to build a Paradox."
[37] Archive message page_1403 (arvent / Nels, `paradoxbuilders`, msgnum 1423, 2003-11-18) — "Re: Tools list": "I don't see how a tools list, or any other kind of list can be copywritten, since they are only suggestions and not carved in stone - wxcept for maybe the ten commandments. Don hasn't laid authorship claim to them yet as far as I know:-))"
[38] Archive message page_1406 (w.serjeant / "barnacleid" / Bill Serjeant, `paradoxbuilders`, msgnum 1426, 2003-11-18) — "Re: Tools list": the two lists differ in derivation — his own tools list was compiled while examining Don's Building Booklet, and is not a list made by Don; freely made available on paradox-uk.co.uk, with no copyright claim. The separate Building Materials list was part of a bought package inclusive of the Paradox plans, and though useful, may be subject to copyright — hence deferring to Matt or Dave to sanction its use before uploading it to the FAQ file.
[39] Archive message page_1421 (LJGeib / "Larry," `paradoxbuilders`, msgnum 1441, 2003-11-18) — "Re: Tools list": "I do not believe you have anything to apologize for. As I recall, you properly referened the list to him."
[40] Archive message page_1447 (kd7ixk / David C. Smith, `paradoxbuilders`, msgnum 1467, 2003-11-24) — "Build Manual, Introduction": posts a draft introduction, inviting additions/omissions/edits; the manual should focus almost entirely on construction, with no personal anecdotes or design-justification; plans next to write up tools, supplies, and working environment; asks for a bibliography and for volunteers to write up spars, rudder, yuloh, vent trunk, and other sections; full draft text: the manual guides builders of Matt Layden's Paradox design, referencing the design's own specifications, and recommends following the design as drawn though builders may alter details to preference; points to Dave Bolduc's microcruising.com for design questions and to the group's own photos/files/archived messages; describes Paradox as a proven heavy-displacement sharpie type from empirical testing of scale models and preceding vessels; the plans use metric measurements, easily mastered with a metric tape measure and 1:10/1:20 scale rule; additional plan copies may be made for the original purchaser's own use (build location, computer, even the head); a build journal/notes and camera are recommended; material choice is left to the builder from the designer's suggested range (ACX to marine-grade plywood, Douglas Fir to Mahogany), so species are referenced ambiguously except where specific; a materials list should be individually worked out, both to ensure plan study and because one builder's list may not suit another's tools/techniques; a chronological task list aids organization; materials need not all be bought at once, though bulk purchase (5 gal epoxy, 10 sheets plywood, a spool of line) can save money; the manual follows a logical build order but smaller tasks (rudder, spars, sail, yuloh) may be tackled in whatever order suits weather, economics, or curing times, respecting task dependencies.
[41] Archive message page_1448 (dlb / "David Beard", `paradoxbuilders`, msgnum 1468, 2003-11-24) — "Re: Build Manual, Introduction": full text and citation at [people/david-beard.md](/people/david-beard.md#citations).
[42] Archive message page_1636 (kd7ixk / David C. Smith, `paradoxbuilders`, msgnum 1658, 2003-12-29) — "Build Manual, Preparations": full build-site guidance (shelter against dew/rain/airborne debris; heating/cooling considerations for epoxy and paint; a garage as optimal but not necessary; a dolly or rolling cradle for moving the boat) and a full categorized tool list (basic tools, measuring tools, edge tools, abrasive tools, saws, rotary tools, clamps, stationary power tools, safety equipment, consumable supplies), framed throughout as a suggested rather than fixed inventory given how much builder experience, preference, and tool availability vary.
[43] Archive message page_1651 (ifida / Glen Maxwell, `paradoxbuilders`, msgnum 1673, 2003-12-30) — "Re: Build Manual, Preparations": "Great start to the manual Smith, glad to see you have access to the files now. I know this manual will be an invaluable asset to future builders."
[44] Archive message page_1653 (kd7ixk / David C. Smith, `paradoxbuilders`, msgnum 1675, 2003-12-30) — "Re: Build Manual, Preparations": thanks Glen; up next are deckbeams, then bulkheads; restates that all contributions are welcome, as are comments, suggestions, and criticism.
[45] Archive message page_1729 (openboat / "Alastair", `paradoxbuilders`, msgnum 1751, 2004-01-02) — "Re: Build Manual, Preparations": good start, but his only criticism is that seeing the full tool list before he began building might have put him off, given all the extra tools it would mean buying; by rough estimate he owns about a tenth of the tools on the list; quotes Smith's full "Preparations" tool list and build-site guidance in full.
[56] Archive message page_1751 (LJGeib / "Larry", `paradoxbuilders`, msgnum 1773, 2004-01-04) — "Re: The tools list": replying to David LeBlanc's quoted line that Nelson's *Victory* was built entirely with hand tools, jokes that he is surprised the shipwrights "eschwed the powered pit saws commonly available then," since they could have learned of them from the Romans, "who first used water power to drive them."
[57] Archive message page_1765 (ifida / "Glen Maxwell", `paradoxbuilders`, msgnum 1788, 2004-01-04) — "Re: Build Manual, Preparations": admits he may be belaboring the point, having just returned from an errand and not yet read all the posts; cannot imagine working without his own old $75 table saw, but concedes Paradox could be built with a hatchet and hand saw, though "not for me... would it be fun?"; a builder doesn't need every tool on the list, but having it in front of you gives a point of departure — start building, and decide whether to add a tool to the chest once a real need for it appears; thanks Smith for taking time away from "Swash" to compile and share the list. Signed "Tailwinds, Glen."
[58] Archive message page_2102 (ron / "rondune508" / Ron, `paradoxbuilders`, msgnum 2127, 2004-06-02) — "building questions": introduces himself as interested in the design; asks how long a Paradox takes to build, what it might cost in "today's market," and whether anyone makes the sail.
[59] Archive message page_2103 (alex29 / "tidybowlmann" / Jack Gardiner, `paradoxbuilders`, msgnum 2128, 2004-06-02) — "Re: building questions": full text and citation at [people/jack-gardiner.md](/people/jack-gardiner.md#citations).
[60] Archive message page_2104 (openboat / "Alastair", `paradoxbuilders`, msgnum 2129, 2004-06-02) — "Re: building questions": his own build took about 18 months of leisurely evenings/weekends and cost about £2,500; took the first plan sheet to a local sailmaker, who made his sail; points to his website (`www.asjg.clara.co.uk/little_jim/`).
[61] Archive message page_2108 (melodymann / "LEON", `paradoxbuilders`, msgnum 2133, 2004-06-02) — "Budget Building": puzzled how such a small boat can cost £2,500 to build, even accounting for wood and epoxy, expecting under £1,000 including sewing the sail himself.
[62] Archive message page_2109 (openboat / "Alastair", `paradoxbuilders`, msgnum 2134, 2004-06-03) — "Re: Budget Building": it can be done more cheaply — Matt Layden himself suggests exterior ply where Alastair used marine grade, not wanting to skimp since he wants the boat to outlast him; regrets having much of his timber pre-planed to size, unnecessary since exact dimensions rarely mattered; full itemized cost breakdown (£600 timber, £375 ply, £630 epoxy and consumables, £30 polystyrene insulation/buoyancy, £170 Lexan, £350 sail) plus bronze nails, stainless screws/bolts, new tools, cleats, fairleads, inspection hatches, anchor, rope, LEDs, a lifejacket, and a cooker; "it all adds up"; the trailer was not included in the £2,500 figure.
[63] Archive message page_2112 (melodymann / "LEON", `paradoxbuilders`, msgnum 2137, 2004-06-08) — "Re: Budget Building": asks where he can find a picture of Alastair's boat.
[64] Archive message page_2114 (openboat / "Alastair", `paradoxbuilders`, msgnum 2139, 2004-06-09) — "Re: Budget Building": points again to `www.asjg.clara.co.uk/little_jim` for "a surfeit of pictures" (duplicate pointer of [60]).
[65] Archive message page_2153 (dclark / "dclark52001" / Derek Clark, `paradoxbuilders`, msgnum 2178, 2004-07-08) — "My First Paradox (Cardboard Mock Up)": built a 1/10-scale cardboard model to check dimensions and refresh his memory of the internal arrangement, having already photographed Alastair's "Little Jim" in person; has plans, a Don Elliott build book, the model, fastenings (recommends Robbins Timber of Bristol as half the price of Classic Marine for UK builders), lead, a building fund, and enough exterior ply for the bulkheads; bought a Land Rover for towing; has arranged part-time work from September to free up building time; hopes to be building by Christmas; notes trouble uploading photos to the group's Albums using Safari on his iMac, fixed by switching to MS Internet Explorer. Signed "Derek."
[66] Archive message page_2154 (dclark / "dclark52001" / Derek Clark, `paradoxbuilders`, msgnum 2179, 2004-07-08) — "My First Paradox (Cardboard Mock Up)" (duplicate of [65], sent with no body content).
[67] Archive message page_2155 (dclark / "dclark52001" / Derek Clark, `paradoxbuilders`, msgnum 2180, 2004-07-08) — "My First Paradox (Cardboard Mock Up)": names his still-unstarted boat "So-So," after his children gave him a personalized logbook for Father's Day and to involve his quilter wife in the project; also a nod to his own woodworking skill. Signed "cheers."
[68] Archive message page_2161 (trisurfnturf / "Matt Wagner", `paradoxbuilders`, msgnum 2186, 2004-07-21) — "Amount of sheets, cloth, epoxy? Building Hours & expense tips": asks how many plywood sheets, yards of glass cloth, and gallons of epoxy a Paradox build needs, not yet owning a set of plans; also asks how many hours other builders spent and for tips reducing expenses; mentions he may sell a set of Bolger Long Micro plans if he starts a Paradox. Signed "Matt Wagner."
[69] Archive message page_2164 (openboat / "Alastair", `paradoxbuilders`, msgnum 2189, 2004-07-22) — "Re: Amount of sheets, cloth, epoxy? Building Hours & expense tips": itemizes plywood (2 sheets 18mm, 4 sheets 12mm, 3 sheets 9mm, 1 sheet 6mm), glass cloth (6 oz, about 14 yards on deck/sides, optional), 4mm woven roving on the bottom (optional, but glad he kept it after scraping rocks), and epoxy (5 gallons then another 5, with plenty left over); restates his own ~£2,500 cost and 18-month build time; points to `www.asjg.clara.co.uk/little_jim` for photos. Signed "Al, Yeovil, England."
[70] Archive message page_2217 (allcritters / "Lee Corbridge, DVM", `paradoxbuilders`, msgnum 2244, 2004-08-31) — "New Member": full text and citation at [operations/first-boat-suitability.md](/operations/first-boat-suitability.md#storage-beachability-and-who-buys-the-beer); asks the build-time-factor and estimated-cost questions among his newcomer introduction.
[71] Archive message page_2219 (openboat / "Alastair", `paradoxbuilders`, msgnum 2246, 2004-08-31) — "Re: New Member": full text and citation at [operations/first-boat-suitability.md](/operations/first-boat-suitability.md#storage-beachability-and-who-buys-the-beer); answers the newcomer's other questions without adding new time/cost figures.
[72] Archive message page_2554 (dclark / "dclark52001" / Derek Clark, `paradoxbuilders`, msgnum 2582, 2005-02-14) — "Enuf": prompted by an enquiry in another group, checked his own photo file ("So-So") and found the build had moved on much further than he remembered over the past six weeks; posted a new picture but withheld close-ups or interior shots, judging them too rough to show; asks that the photo file be renamed from "So-So" to "Enuf" to match the boat's now-settled name.
[73] Archive message page_2640 (dclark / "dclark52001" / Derek Clark, `paradoxbuilders`, msgnum 2670, 2005-04-29) — "A day's work": built a trolley to move "Enuf" between his workshop and driveway from recycled, welded-on wheels (freed with an angle grinder) bolted to a new wooden frame; raised the hull with levers, wood blocks, trolley jacks, and axle stands to slide the trolley underneath; the trolley worked well until, pushing the boat back into the workshop, its front wheels caught the half-inch door-sill lip, tore out of the wooden frame, and the hull skidded back onto its original resting blocks — a "heated exchange" with his son followed.
[74] Archive message page_2671 (mbolduc / "boldav38" / Dave Bolduc, `paradoxbuilders`, msgnum 2671, 2005-04-30) — "Re: A day's work": built "the big wheel" the previous year to turn over Little Cruiser, after years of relying on a neighbor or his 105 lb wife to help move her, always fearing damage; now moves the boat solo with a block and tackle, a jack, or the big wheel — slower, but avoids the stress of working with others who may handle a heavy hull less carefully; links a photo of the Bolducs' sharpie trailer (`microcruising.com/Graphics/trailer1b.jpg`). Signed "Dave."
[75] Archive message page_2672 (dclark / "dclark52001" / Derek Clark, `paradoxbuilders`, msgnum 2672, 2005-04-30) — "Re: A day's work": adopting a simpler method — a spare set of dinghy-trailer wheels and an axle strapped to a wooden baulk under the hull's point of balance — and found "Enuf" slid easily along on timber and concrete once set up this way; thanks Dave for the trailer photo, having seen similar trailers on eBay; invites the Bolducs to visit Wolverhampton if ever in the UK. Signed "Derek."
[76] Archive message page_2678 (adrian.dodd2 / "Adrian Dodd", `paradoxbuilders`, msgnum 2708, 2005-05-14) — "How heavy without ballast?": has been considering the Paradox for months; building space is available but access is awkward, so he expects to build at home before moving the boat elsewhere to fit out; would need to manhandle her over one or two obstructions; asks roughly how heavy the bare hull is during building.
[77] Archive message page_2683 (mbolduc / "boldav38" / Dave Bolduc, `paradoxbuilders`, msgnum 2713, 2005-05-15) — "Re: How heavy without ballast?": guesses the bare hull runs 450–500 lb.
[78] Archive message page_2688 (ifida / "Glen C. Maxwell", `paradoxbuilders`, msgnum 2718, 2005-05-17) — "Re: How heavy without ballast?": guesses "Zoë" came in around 350–400 lb before cabinets and ballast.
[79] Archive message page_2689 (adrian.dodd2 / "Adrian Dodd", `paradoxbuilders`, msgnum 2719, 2005-05-17) — "Re: How heavy without ballast?": relieved that 350 lb is manageable enough that he could get help sliding the hull over a few 5 ft walls; asks separately what stage of the hull construction tends to be most time-consuming, having not yet ordered plans and considering waiting for a possible precut kit.
[80] Archive message page_2690 (dclark / "dclark52001" / Derek Clark, `paradoxbuilders`, msgnum 2720, 2005-05-19) — "Re: How heavy without ballast?": building "Enuf"; as a bare hull, his 20-year-old son and two friends lifted her easily by hand, helped (he jokes) by his own detailed instructions shouted from nearby; further along, with the decks going on and some ballast aboard, he can slide her around solo on wooden blocks, and guesses 5–6 fit people could lift her a foot or so into the air at that stage — his trailer was due to arrive days later; no single build stage stood out as especially time-consuming (spread out with breaks since the previous August), but scarf joints in panels were consistently irritating (used a lapped butt joint for the floor instead), and chine logs were a pain (narrowed his own to simplify them, and warns against leaving the vent box out until after the bulkheads are fitted, a mistake he made himself); judges a precut kit would not have detracted from the pleasure of building; separately vouches for Alec Jordan, who built him a hull for an unrelated Paul Fisher Coble design, as an honest, good-quality builder despite delays from Alec's ill health.
[81] Archive message page_2692 (adrian.dodd2 / "Adrian Dodd", `paradoxbuilders`, msgnum 2722, 2005-05-19) — "Re: PS": thanks the list, feels close to a decision; asks Derek Clark whether his moving crew ("those boys") are big lads or little ones, since he expects to be doing all the persuading himself if he ever needs help moving his own Paradox; has mixed feelings about a precut kit, since building from start to finish is part of Paradox's appeal, but concedes the important thing is getting a boat in the water; recalls being drawn to more traditional-looking small cruisers (a Wee Seal, a Humber canoe yawl) before realizing an elaborate first build risked never finishing; now finds Paradox beautiful in its own right, drawn back to it because "she has done so much in reality, not just on paper."
[82] Archive message page_2694 (dclark / "dclark52001" / Derek Clark, `paradoxbuilders`, msgnum 2724, 2005-05-20) — "Re: PS": jokes that his moving crew are all 20-year-old "weedy, weed using, lager louts/art students" who perform in a modern metal band and are starting to get paid gigs, and who still owe him for start-up money he lent them; on kit-vs-scratch, says a kit would only save time — he has enjoyed the build in spite of his own mistakes, most of which came from not reading the instructions carefully, and rates it "a bit more complicated than an Ikea flat pack"; agrees Paradox's practical track record is the main thing, since in his view all the negative comments about the design come from theoreticians rather than owners; wonders aloud what is beautiful about sitting out in the rain and cold of English weather.
[83] Archive message page_2693 (openboat / "alopenboat" / Alastair, `paradoxbuilders`, msgnum 2723, 2005-05-19) — "Re: PS": reassures Adrian Dodd that even if a moving crew tires out partway through, the hull can simply be left propped on a few rocks with no harm done — "no danger of putting a hole in that 18mm bottom!" Signed "Al, Yeovil, England," "Hoping for calm nights."
[84] Archive message page_2698 (fasttimes / Brent Geery, `paradoxbuilders`, msgnum 2728, 2005-05-28) — "Introduction": Los Angeles-based, already owns Don Elliott's construction book with the plans just arrived; plans to start building in the fall (winter building preferable to 100°F Los Angeles summer heat); will build as an apartment dweller in the space of an outside car-parking spot (roughly 8 ft x 15 ft), with additional temporary room available just to its front.
