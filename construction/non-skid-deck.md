...
[5] Archive message page_1055 (kd7ixk / "DC", `paradoxbuilders`, msgnum 1071, 2003-07-09) — "materials": sand-in-paint non-skid is easy but needs frequent overcoating and is a frustration to remove later; likes Glen's walnut-shell-in-epoxy method; after installing many non-skid surfaces on pleasure and commercial boats, prefers a product formerly called "Flex-o-Tex"/"Dex-o-Tex," now "Spantex" — a latex rubber base with Hypalon rubber chunks for grip, applied as a base coat (with the chunks) then a color finish coat over 24-grit-roughened, paint/varnish-stripped surfaces; used it on his last boat with no maintenance for eight years, ice to desert; refreshed later with TSP scrubbing and a new finish coat; has applied it over fiberglass, bare plywood, planked decks, and concrete.
